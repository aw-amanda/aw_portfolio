    ...
    return (
        <section id="skills"
            ...
            <div className="p-2 md:m-2">
                <h3 className="font-[Fascinate_Inline] my-10 text-center text-3xl md:text-6xl text-transparent 
                ...
                <ul className="skill-box flex flex-wrap justify-center gap-3">
                    {['HTML', 'CSS', 'JavaScript', 'TypeScript', 'React.js', 'Next.js', 'TailwindCSS', 
                        ...
                        <li 
                            key={skill} 
                            className="animated-gradient-wave px-2 py-1 md:px-4 md:py-2 text-white font-semibold rounded-lg 
